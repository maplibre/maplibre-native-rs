use wgpu::{
    AddressMode, BindGroupLayoutEntry, BindingType, BlendFactor, BlendOperation, BufferBindingType,
    BufferDescriptor, BufferUsages, CommandEncoderDescriptor, CompareFunction, Extent3d, Face,
    FilterMode, FrontFace, IndexFormat, MipmapFilterMode, PrimitiveTopology, QueryType,
    SamplerBindingType, SamplerDescriptor, ShaderStages, StencilOperation, StorageTextureAccess,
...
use crate::{
    ...
    WGPUAddressMode_Repeat, WGPUBlendFactor_Constant, WGPUBlendFactor_Dst,
    WGPUBlendFactor_DstAlpha, WGPUBlendFactor_One, WGPUBlendFactor_OneMinusConstant,
    WGPUBlendFactor_OneMinusDst, WGPUBlendFactor_OneMinusDstAlpha, WGPUBlendFactor_OneMinusSrc,
    WGPUBlendFactor_OneMinusSrcAlpha, WGPUBlendFactor_Src, WGPUBlendFactor_SrcAlpha,
    WGPUBlendFactor_SrcAlphaSaturated, WGPUBlendFactor_Zero, WGPUBlendOperation_Add,
    WGPUBlendOperation_Max, WGPUBlendOperation_Min, WGPUBlendOperation_ReverseSubtract,
    WGPUBlendOperation_Subtract, WGPUBufferDescriptor, WGPUCommandEncoderDescriptor,
    ...
    WGPUCompareFunction_Never, WGPUCompareFunction_NotEqual, WGPUCullMode_Back, WGPUCullMode_Front,
    WGPUCullMode_None, WGPUFilterMode_Linear, WGPUFrontFace_CCW, WGPUFrontFace_CW,
    WGPUIndexFormat_Uint16, WGPUIndexFormat_Uint32, WGPUMipmapFilterMode_Linear,
    ...
    WGPUPrimitiveTopology_TriangleStrip, WGPUQueryType_Occlusion, WGPUQueryType_Timestamp,
    WGPUSamplerDescriptor, WGPUStencilOperation_DecrementClamp, WGPUStencilOperation_DecrementWrap,
    WGPUStencilOperation_IncrementClamp, WGPUStencilOperation_IncrementWrap,
    WGPUStencilOperation_Invert, WGPUStencilOperation_Keep, WGPUStencilOperation_Replace,
    WGPUStencilOperation_Zero, WGPUStringView, WGPUTextureAspect_DepthOnly,
    WGPUTextureAspect_StencilOnly, WGPUTextureAspect_Undefined, WGPUTextureDescriptor,
    WGPUTextureDimension_1D, WGPUTextureDimension_3D, WGPUTextureFormat_BGRA8Unorm,
    WGPUTextureFormat_BGRA8UnormSrgb, WGPUTextureFormat_Depth16Unorm,
    ...
    WGPUTextureViewDimension_Undefined, WGPUVertexFormat_Float16, WGPUVertexFormat_Float16x2,
    WGPUVertexFormat_Float16x4, WGPUVertexFormat_Float32, WGPUVertexFormat_Float32x2,
    WGPUVertexFormat_Float32x3, WGPUVertexFormat_Float32x4, WGPUVertexFormat_Sint8,
    WGPUVertexFormat_Sint8x2, WGPUVertexFormat_Sint8x4, WGPUVertexFormat_Sint16,
    WGPUVertexFormat_Sint16x2, WGPUVertexFormat_Sint16x4, WGPUVertexFormat_Sint32,
    WGPUVertexFormat_Sint32x2, WGPUVertexFormat_Sint32x3, WGPUVertexFormat_Sint32x4,
    WGPUVertexFormat_Snorm8, WGPUVertexFormat_Snorm8x2, WGPUVertexFormat_Snorm8x4,
    WGPUVertexFormat_Snorm16, WGPUVertexFormat_Snorm16x2, WGPUVertexFormat_Snorm16x4,
    WGPUVertexFormat_Uint8, WGPUVertexFormat_Uint8x2, WGPUVertexFormat_Uint8x4,
    WGPUVertexFormat_Uint16, WGPUVertexFormat_Uint16x2, WGPUVertexFormat_Uint16x4,
    WGPUVertexFormat_Uint32, WGPUVertexFormat_Uint32x2, WGPUVertexFormat_Uint32x3,
    WGPUVertexFormat_Uint32x4, WGPUVertexFormat_Unorm8, WGPUVertexFormat_Unorm8x2,
    WGPUVertexFormat_Unorm8x4, WGPUVertexFormat_Unorm8x4BGRA, WGPUVertexFormat_Unorm10_10_10_2,
    WGPUVertexFormat_Unorm16, WGPUVertexFormat_Unorm16x2, WGPUVertexFormat_Unorm16x4,
