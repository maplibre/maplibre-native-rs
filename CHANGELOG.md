...
- *(deps)* update `maplibre-native` ([#281](https://github.com/maplibre/maplibre-native-rs/pull/281))
- *(deps)* bump taiki-e/install-action from 2.85.10 to 2.87.0 in the all-actions-version-updates group ([#282](https://github.com/maplibre/maplibre-native-rs/pull/282))
...
- *(renderer)* [**breaking**] make continuous rendering host-driven ([#271](https://github.com/maplibre/maplibre-native-rs/pull/271))

### Other

- *(deps)* bump the all-actions-version-updates group with 2 updates ([#268](https://github.com/maplibre/maplibre-native-rs/pull/268))
