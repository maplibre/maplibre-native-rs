...
## [0.4.2](https://github.com/maplibre/maplibre-native-rs/compare/v0.4.1...v0.4.2) - 2025-11-03

### Other

- *(deps)* bump taiki-e/install-action from 2.62.38 to 2.62.45 in the all-actions-version-updates group ([#103](https://github.com/maplibre/maplibre-native-rs/pull/103))
