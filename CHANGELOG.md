...
- *(deps)* bump taiki-e/install-action from 2.77.4 to 2.79.0 in the all-actions-version-updates group ([#178](https://github.com/maplibre/maplibre-native-rs/pull/178))
