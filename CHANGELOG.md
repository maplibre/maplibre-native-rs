...
## [0.5.1](https://github.com/maplibre/maplibre-native-rs/compare/v0.5.0...v0.5.1) - 2026-05-21

### Added

- *(renderer)* add dedicated run loop mode for multithreaded environments ([#188](https://github.com/maplibre/maplibre-native-rs/pull/188))
